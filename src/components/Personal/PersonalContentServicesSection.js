...
class PersonalContentServicesSection extends Component {
  constructor(props) {
    super(props);
    this.countUpData = {
      'Projects Completed': 2536,
      'Happy Clients': 6784,
      'Cups of Coffee': 2239,
      'Real Professionals': 435,
    };
  }
              ...
              <div className="menu-content  col-lg-7">
                <div className="title text-center">
                  ...
                  <p>
                    ...
                    some months after New Year’s resolutions have been made and kept,
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-services">
                  ...
                  <p>
                    ...
                    you know that your success cannot depend on the opinions of others.
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-services">
                  ...
                  <p>
                    ...
                    Learn to love learning and growth.
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-services">
                  ...
                  <p>
                    Hypnosis quit smoking methods maintain caused quite a stir in the medical world.
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-services">
                  ...
                  <p>
                    Do you sometimes have the feeling that you’re running into the same obstacles
                     over and over again?
              ...
              <div className="col-lg-4 col-md-6">
                <div className="single-services">
                  ...
                  <p>You’ve heard the expression, “Just believe it and it will come.”
                   Well, technically, that is true, however,
